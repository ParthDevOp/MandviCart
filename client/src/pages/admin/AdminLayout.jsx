...
const AdminLayout = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row font-outfit">
            <div className="w-full md:w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col">
                <div className="p-6 border-b border-gray-100 flex flex-col gap-2">
                    <img src={assets.logo} alt="GreenCart" className="w-32" />
                    <div className="bg-blue-50 text-blue-600 px-3 py-1 rounded-full text-[10px] font-bold tracking-wider flex items-center gap-1 w-fit">
                ...
                <nav className="flex-1 p-4 space-y-1">
                    {sidebarLinks.map((item) => (
                        <NavLink 
                            ...
                            className={({ isActive }) => `flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-medium text-sm ${isActive ? 'bg-green-600 text-white shadow-lg shadow-green-200' : 'text-gray-500 hover:bg-gray-50'}`}
                        >
                ...
                <div className="p-4 border-t border-gray-100">
                    <button onClick={logout} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-500 hover:bg-red-50 hover:text-red-500 transition-colors text-sm font-medium">
